...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes = 1000, zero_init_residual = False, groups = 1, width_per_group = 64, replace_stride_with_dilation = None, norm_layer = None):
        ...
        # Inicialización a cero las ultimas BN en cada rama resiudal,
        # cada rama residual empieza con ceros, y cada bloque residual se comporta como una identidad.
        # Mejora el modelo 0.2~0.3% de acuerdo con https://arxiv.org/abs/1706.02677
