...
print (torch.cuda.is_available())
path = '/home/usuaris/imatge/alex.mateo/Downloads/icarl/saved_models/best_model2'
...
if (type(train_set) is iCIFAR100):
    fname = 'iCIFAR100pretrained' + str(num_classes) + str(0)
    fname_loss = 'iCIFAR100pretrained_loss' + str(num_classes) + str(0)
